function GPSChart() {
  this.ctx = document.getElementById('gpsChart');
  this.chart = null;
}

GPSChart.prototype.draw = function (data) {
...
GPSChart.prototype.timeToString = function (time) {
...
GPSChart.prototype.update = function (data) {
  console.log(data);
